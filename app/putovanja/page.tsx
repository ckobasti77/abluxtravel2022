    ...
    () => [
      {
        id: "iceland",
        title: "Iceland",
        subtitle: "5 dana / 4 noći / Reykjavik + Golden Circle",
        badge: "4 noćenja",
      ...
      },
      {
        id: "cappadocia",
        title: "Cappadocia",
        subtitle: "4 dana / 3 noći / Let balonom u zoru",
        badge: "3 noćenja",
      ...
      },
      {
        id: "amalfi",
        title: "Amalfi",
        subtitle: "7 dana / 6 noći / Obala, limuni i more",
        badge: "6 noćenja",
  ...
  const copy =
    language === "sr"
      ? {
          ...
          emptyDescription:
            "Trenutno nema aktivnih scena. Novi prikazi destinacija biće dodati uskoro.",
          previous: "Prethodna",
          next: "Sledeća",
          jumpTo: "Idi na scenu",
